const verticalMenuData = dictionary => [
  ...
  // This is how you will normally render menu section
  {
    ...
    children: [
      ...
      {
    label: dictionary?.navigation?.clients || 'Clients',
    href: '/clients',
    icon: 'ri-user-3-line',
    exactMatch: false,
    activeUrl: '/clients'
  ...
  {
    label: dictionary?.navigation?.leads || 'Leads',
    href: '/leads',
    ...
    activeUrl: '/leads'
      ...
      {
        label: 'Feature Assignments',
        href: '/feature-assignments',
      ...
      {
        label: dictionary?.navigation?.superAdmin || 'Super Admin',
        href: '/super-admin',
        icon: 'ri-shield-user-line',
        exactMatch: false,
        activeUrl: '/super-admin'
      },
      {
        ...
        children: [
          ...
          // Only show settings for Super Admin users
          ...(typeof window !== 'undefined' && 
              (JSON.parse(sessionStorage.getItem('userRole') || '""') === 'SUPER_ADMIN' ||
               JSON.parse(localStorage.getItem('userRole') || '""') === 'SUPER_ADMIN') 
              ? [{
                  label: dictionary['navigation'].settings,
                  href: '/settings',
                  icon: 'ri-settings-3-line'
