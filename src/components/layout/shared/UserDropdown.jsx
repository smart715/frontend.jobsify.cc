            ...
            >
              <ClickAwayListener onClickAway={e => handleDropdownClose(e)}>
                <MenuList>
                  ...
                  <MenuItem className='gap-3 pli-4' onClick={e => handleDropdownClose(e, `/${locale}/dashboards/site-settings`)}>
                    <i className='ri-settings-4-line' />
                    <Typography color='text.primary'>Site Settings</Typography>
                  </MenuItem>
                  <MenuItem className='gap-3 pli-4' onClick={() => updateSettings({ isOpen: true })}>
                    <i className='ri-palette-line' />
                    <Typography color='text.primary'>Site Design</Typography>
                  </MenuItem>
