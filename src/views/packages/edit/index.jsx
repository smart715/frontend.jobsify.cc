...
const EditPackage = ({ onSubmit, packageData }) => {
  ...
  const {
    ...
    defaultValues: {
      packageType: packageData?.packageType || 'paid',
      name: packageData?.name || '',
      maxEmployees: packageData?.maxEmployees || '',
      positionNo: packageData?.positionNo || '',
      private: packageData?.private || false,
      recommended: packageData?.recommended || false,
      monthly_currency: packageData?.monthly_currency || 'USD',
      yearly_currency: packageData?.yearly_currency || 'USD',
      hasMonthly: packageData?.hasMonthly || false,
      monthlyPrice: packageData?.monthlyPrice || '',
      hasAnnual: packageData?.hasAnnual || false,
      annualPrice: packageData?.annualPrice || '',
    ...
    const fetchData = async () => {
      try {
        ...
        if (featuresRes.ok && modulesRes.ok) {
          ...
          setModuleOptions(modulesData.filter(m => m.isActive))
        } else {
